...
module.exports = {
  ...
  async getUserDetails(catalystApp) {
    ...
    /**
     * Le userDetails est nul quand on met l'id en dur sans connexion donc avec cette condition normalement on devrait être bon
     * faudrait que tu test de ton coté aussi pour voir si ça fait pas tout planter
     */
    let query;
    if (!userDetails) {
