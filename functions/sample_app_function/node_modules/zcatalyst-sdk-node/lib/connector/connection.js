...
class Connection {
    constructor(app, propJson) {
        ...
        this.connectionJson = connectorValidator_1.getConnectorJson(propJson);
    }
    getConnector(connectorName) {
        ...
        validator_1.isNonNullObject(connector, 'connector.' + connectorName, true);
        validator_1.ObjectHasProperties(connector, [CLIENT_ID, CLIENT_SECRET, AUTH_URL, REFRESH_URL], 'connector.' + connectorName, true);
