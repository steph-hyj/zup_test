...
class Connector {
    ...
    generateAccessToken(code) {
        return __awaiter(this, void 0, void 0, function* () {
            yield validator_1.wrapValidatorsWithPromise(() => {
                validator_1.isNonEmptyString(code, 'grant_token', true);
                validator_1.isNonEmptyString(this.redirectUrl, REDIRECT_URL, true);
            ...
            yield validator_1.wrapValidatorsWithPromise(() => {
                validator_1.isNonNullObject(tokenObj, 'auth_response', true);
                validator_1.ObjectHasProperties(tokenObj, [ACCESS_TOKEN, REFRESH_TOKEN, EXPIRES_IN], 'auth_response', true);
            }, error_1.CatalystConnectorError);
    ...
    refreshAccessToken() {
        return __awaiter(this, void 0, void 0, function* () {
            yield validator_1.wrapValidatorsWithPromise(() => {
                validator_1.isNonEmptyString(this.refreshToken, 'refresh_token', true);
                validator_1.isNonEmptyString(this.refreshUrl, 'refresh_url', true);
            }, error_1.CatalystConnectorError);
            const request = {
                method: REQ_METHOD.post,
                url: this.refreshUrl,
            ...
            yield validator_1.wrapValidatorsWithPromise(() => {
                validator_1.isNonNullObject(tokenObject, 'auth_response', true);
                validator_1.ObjectHasProperties(tokenObject, [ACCESS_TOKEN, EXPIRES_IN], 'auth_response', true);
            }, error_1.CatalystConnectorError);
