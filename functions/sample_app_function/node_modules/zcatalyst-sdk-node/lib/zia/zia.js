...
class Zia {
    ...
    extractAadhaarCharacters(frontImg, backImg, language) {
        return __awaiter(this, void 0, void 0, function* () {
            yield validator_1.wrapValidatorsWithPromise(() => {
                validator_1.isNonEmptyString(language, 'language', true);
    ...
    compareFace(sourceImage, queryImage) {
        return __awaiter(this, void 0, void 0, function* () {
            yield validator_1.wrapValidatorsWithPromise(() => {
                validator_1.isValidType(sourceImage, 'object', 'source_image', true);
                validator_1.isValidType(queryImage, 'object', 'query_image', true);
            }, error_1.CatalystZiaError);
            const formData = new form_data_1.default();
    ...
    getSentimentAnalysis(listOfDocuments, keywords) {
        return __awaiter(this, void 0, void 0, function* () {
            return zia_text_analysis_1._getSentimentAnalysis(this.requester, listOfDocuments, keywords);
        });
    }
    /**
    ...
    getKeywordExtraction(listOfDocuments) {
        return __awaiter(this, void 0, void 0, function* () {
            return zia_text_analysis_1._getKeywordExtraction(this.requester, listOfDocuments);
        });
    }
    /**
    ...
    getNERPrediction(listOfDocuments) {
        return __awaiter(this, void 0, void 0, function* () {
            return zia_text_analysis_1._getNERPrediction(this.requester, listOfDocuments);
        });
    }
    /**
    ...
    getTextAnalytics(listOfDocuments, keywords) {
        return __awaiter(this, void 0, void 0, function* () {
            return zia_text_analysis_1._getTextAnalytics(this.requester, listOfDocuments, keywords);
        });
    }
}
exports.Zia = Zia;
